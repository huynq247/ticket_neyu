...
class FileBasedDB:
    def __init__(self, base_dir="./data/notifications"):
        self.base_dir = base_dir
        os.makedirs(base_dir, exist_ok=True)
        
        # Create a simple collection-like interface
        self.notifications = FileCollection(os.path.join(base_dir, "notifications"))
        self.templates = FileCollection(os.path.join(base_dir, "templates"))
        self.settings = FileCollection(os.path.join(base_dir, "settings"))
...
Write-Host "Starting Notification Service with Python 3.10..." -ForegroundColor Yellow
& $pythonPath main.py
